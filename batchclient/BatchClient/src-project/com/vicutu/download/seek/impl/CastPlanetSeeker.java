...
public class CastPlanetSeeker extends AbstractSeeker {
	...
	private boolean filtUrl(String linkUrl0, String linkUrl, String lastLinkUrl, String parentUrl) {
		return !linkUrl0.equals(lastLinkUrl) && !linkUrl0.equals(linkUrl)
				&& linkUrl0.toLowerCase().startsWith(parentUrl.toLowerCase()) && !linkUrl0.endsWith("php")
				&& !linkUrl0.endsWith(".wmv") && !linkUrl0.endsWith(".jpg") && !linkUrl0.endsWith(PAGE_ONE_SUFFIX);
	}
