...
IndexPage = Ext.extend(Ext.Viewport, {
			...
			items : [{
						...
						items : [{
							...
							loader : new Ext.tree.TreeLoader({
										...
										dataUrl : appContextPath
												+ "/menu/getTreeNodeById.do"
									}),
							// 根节点
						...
						frame : true, // 强制背景色
						height : 27,// 高度
						html : "<div align=\"right\"><font color=\"#15428b\">Developer:PengfeiDi　Email:dipengfei1982@gmail.com　MSN:dipengfei@live.cn</font></div>"
					}]
		})
	...
	addTab : function(_name, _id, _css, _link) {
		...
		if (!tab) {
			...
			newTab.load({
				url : appContextPath + tabLink, // 请求服务器的地址
