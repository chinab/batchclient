...
<script type="text/javascript">
			 ...
			 var _addEmployeeFormPanel=new AddEmployeeFormPanel({myid:subMainId});
			 //设置宽度
			 _addEmployeeFormPanel.width=w;
			 //设置高度
			 _addEmployeeFormPanel.height=h;
			 //渲染组件
			 _addEmployeeFormPanel.render(subMainId+'p');			 
</script>
