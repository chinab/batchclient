...
<script type="text/javascript">
			 ...
			 //实例化人员档案信息登记表单面板
			 var _editEmployeeGridPanel=new EditEmployeeGridPanel({myid:subMainId});
			 //设置宽度
			 _editEmployeeGridPanel.width=w;
			 //设置高度
			 _editEmployeeGridPanel.height=h;
			 //渲染组件
			 _editEmployeeGridPanel.render(subMainId+'p');			 
</script>