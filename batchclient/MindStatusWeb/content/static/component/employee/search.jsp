			...
			<td>
				<table class="main_table1">
					<tr>
						...
						<td>生日<br></td>
 						<td colspan="3">
 							<html:text property="birthdayBegin" size="15" maxlength="15" styleClass="clsInput" style="ime-mode:disabled" onfocus="if (window.calendar) new calendar(event.srcElement, 0, 1); "/>&nbsp;至&nbsp;<html:text property="birthdayEnd" size="15" maxlength="15" style="ime-mode:disabled" onfocus="if (window.calendar) new calendar(event.srcElement, 0, 1);"  styleClass="clsInput"/>
 						<br></td> 
 					...
 					<tr>
						...
						<td width="15%">
							<div class="box">
 								<div class="box2">
									<html:select property="eduQualification">
 						...
 						<td>
 							<div class="box">
 								<div class="box2">
 									<html:select property="politicalAppearance">
 					...
 					<tr>						
						...
						<div class="box">
 								<div class="box2">
							<html:select property="associateRelation">
					...
					<tr>
		 			...
		 			<tr>
						<td style="height:30;" colspan=8 align="right">
							<table cellspacing="0" class="main_table1">
							    <tr> 
							      	<td align="right"> 
					...
					<tbody>
							...
							<logic:iterate id="element" name="msEmployeeList">
								<tr>
									...
									<td><img src="<%=imgPath%>/view.gif" style="cursor:hand" onclick="onMore('<bean:write name="element" property="id"/>')"></img></td>
									<td><img src="<%=imgPath%>/role.gif" style="cursor:hand" onclick="onPhysiologyCycle('<bean:write name="element" property="id"/>')"></img></td>
								</tr>
							</logic:iterate>
					</tbody>
				</table>
