...
public class Pagination<E> {
	...
	public Pagination(List<E> items, int totalCount) {
		setTotal(totalCount);
		setItems(items);
		setStart(0);
	}

	public Pagination(List<E> items, int totalCount, int startIndex) {
		setTotal(totalCount);
		setItems(items);
		setStart(startIndex);
	}

	public Pagination(List<E> items, int total, int limit, int start) {
		setLimit(limit);
		setTotal(total);
		setItems(items);
		setStart(start);
