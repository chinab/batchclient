package com.mindstatus.module.query;
...
public class MsEmployeeQuery implements java.io.Serializable
{

	private static final long serialVersionUID = -7094736976125044899L;
	...
	/** default constructor */
	public MsEmployeeQuery()
	{
	}

	/** minimal constructor */
	public MsEmployeeQuery(Integer id)
	{
		this.id = id;
	}
