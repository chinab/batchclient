...
<html:form action="/processEmployeeInsert" onsubmit="return validate(this)">
	<table cellspacing="1" class="main_table1">
		<tr>
        	<td> 
				<table cellspacing="0" class="main_table1">
			    	<tr> 
			      		<td class="text_title">思想状况录入（带*项必填）</td>      		
			    	</tr>
				</table>  
			</td>
		</tr>
 				...
 				<table id="tblData" cellspacing="0"  bgcolor="#FFFFFF" class="main_table3">
					...
					<tr>
						...
						<td width="15%"><html:text property="name" size="15" maxlength="20" styleClass="clsInput"/>&nbsp;<span class="clsFillin">*</span></td>
 						<td width="10%">生日</td>
 						<td width="15%">
 							<html:text property="birthday" size="15" maxlength="15" style="ime-mode:disabled" onfocus="if (window.calendar) new calendar(event.srcElement, 0, 1);" styleClass="clsInput" onblur="getAge()"/>&nbsp;<span class="clsFillin">*</span>
 						</td>
 						<td width="10%">年龄</td>
						...
						<td width="10%">性别</td>
 						<td width="15%"> 							
 							<div class="box">
 								<div class="box2">
 									<html:select property="sex" styleClass="clsInput">
