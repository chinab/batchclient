...
public class QueryTemplateImpl implements QueryTemplate,Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8428651789261626829L;
	...
	public QueryTemplateImpl(Element e, String defaultQueryName)
	{
		...
		while (it.hasNext())
		{
			...
			String operator = XmlUtils.getAttribute(propertyDef, "operator", CriterionSource.OPERATOR_EQUAL);
			String match = XmlUtils.getAttribute(propertyDef, "match", null);
			CriterionSource criterionSource = new CriterionSource(obj, null, operator, match);
	...
	{
		CriterionSource criterionSource = (CriterionSource) criterions.getValue(index);
